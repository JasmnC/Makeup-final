...
import ui.Cashier.CashierPanel;
...
public class CashierRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem ecosystem) {
        this.type = RoleType.Cashier;
        return new CashierPanel(userProcessContainer, account, (FinanceOrganization) organization, (FinanceEnterprise) enterprise, network, ecosystem);
    }
